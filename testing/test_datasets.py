...
class TestMNIST(unittest.TestCase, TestDataSet):
...
class TestRotatedMNIST(unittest.TestCase, TestDataSet):
    def __init__(self, methodName='runTest'):
        super().__init__(methodName)
...
class TestCIFAR10(unittest.TestCase, TestDataSet):
    def __init__(self, methodName='runTest'):
        super().__init__(methodName)
        self.data = CIFAR10()
...
class TestCIFAR10_C(unittest.TestCase, TestDataSet):
    def __init__(self, methodName='runTest'):
        super().__init__(methodName)
...
class TestUCI(unittest.TestCase, TestDataSet):
    def __init__(self, methodName='runTest'):
        super().__init__(methodName)
