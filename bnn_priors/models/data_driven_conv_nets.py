...
def DataDrivenDoubleGammaClassificationConvNet(
    ...
    layers = [Reshape(-1, in_channels, img_height, img_height),
              Conv2dPrior(in_channels, width, kernel_size=3, padding=1,
                          ...
                          loc_w=torch.from_numpy(mean_covs['net.module.1.weight_prior.p'][0]),
                          std_w=torch.from_numpy(mean_covs['net.module.1.weight_prior.p'][1]),
                          prior_b=prior.JohnsonSU,
                          loc_b=fits['net.module.1.bias_prior.p']["johnsonsu"][2],
                          std_b=fits['net.module.1.bias_prior.p']["johnsonsu"][3],
                          scaling_fn=no_scaling,
                          bias_prior_params=dict(
                              inner_loc=fits['net.module.1.bias_prior.p']["johnsonsu"][0],
                              inner_scale=fits['net.module.1.bias_prior.p']["johnsonsu"][1],
                          )),
              nn.ReLU(), nn.MaxPool2d(2),
              Conv2dPrior(width, width, kernel_size=3, padding=1,
                          ...
                          std_w=torch.from_numpy(mean_covs['net.module.4.weight_prior.p'][1]),
                          prior_b=prior.JohnsonSU,
                          loc_b=fits['net.module.4.bias_prior.p']["johnsonsu"][2],
                          std_b=fits['net.module.4.bias_prior.p']["johnsonsu"][3],
                          scaling_fn=no_scaling,
                          bias_prior_params=dict(
                              inner_loc=fits['net.module.4.bias_prior.p']["johnsonsu"][0],
                              inner_scale=fits['net.module.4.bias_prior.p']["johnsonsu"][1],
                          ),
